...
3. Configurar el plugin en *WooCommerce -> SMS Notifications* o a través del botón *Ajustes*.
...
- Corregido el valor vacío de las variables del pedido (*order_total*, *order_tax*, *order_shipping*, etc.) con HPOS activado.
- Compatibilidad con WordPress 7.0 y WooCommerce 10.9.0.
...
- Corrección de error que provoca el envío masivo de correos a la cuenta del autor.
