  ...
  <form method="post" action="options.php">
    ...
    <table class="form-table apg-table">
      ...
      <tr valign="top" class="<?php echo $estado_personalizado; ?>"><!-- <?php echo $nombre_de_estado; ?> -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[<?php echo $estado_personalizado; ?>]"> <?php echo sprintf( __( '%s state custom message:', 'woocommerce-apg-sms-notifications' ), $nombre_de_estado ); ?> </label>
