<div class="wrap woocommerce">
  ...
  <h2>
    <?php _e('APG SMS Notifications Options.', IDIOMA); ?>
  </h2>
  <hr />
  <?php 
		settings_errors(); 
  ...
  ?>
  <h3><a href="<?php echo URL_PLUGIN; ?>" title="Art Project Group"><?php echo PLUGIN; ?></a></h3>
  <p>
    <?php _e('Add to WooCommerce the possibility to send <abbr title="Short Message Service" lang="en">SMS</abbr> notifications to the client each time you change the order status. Notifies the owner, if desired, when the store has a new order. You can also send customer notes.', IDIOMA); ?>
  </p>
  <?php include('cuadro-donacion.php'); ?>
  <form method="post" action="options.php">
    <?php settings_fields('apg_sms_settings_group'); ?>
    <div class="cabecera"> <a href="<?php echo URL_PLUGIN; ?>" title="<?php echo PLUGIN; ?>"><img src="<?php echo URL_IMAGEN; ?>" width="582" height="139" /></a> </div>
    <table class="form-table">
      <tr valign="top">
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[servicio]">
            <?php _e('<abbr title="Short Message Service" lang="en">SMS</abbr> gateway:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php _e('Select your SMS gateway', IDIOMA); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="solutions_infini"><!-- Solutions Infini -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[clave_solutions_infini]">
          ...
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('key', IDIOMA), "Solutions Infini"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="solutions_infini"><!-- Solutions Infini -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[identificador_solutions_infini]">
            <?php _e('Sender ID:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('sender ID', IDIOMA), "Solutions Infini"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="twillio"><!-- Twillio -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[clave_twillio]">
            <?php _e('Account Sid:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('account Sid', IDIOMA), "Twillio"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="twillio"><!-- Twillio -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[identificador_twillio]">
            <?php _e('Auth Token:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('auth token', IDIOMA), "Twillio"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="clickatell"><!-- Clickatell -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[identificador_clickatell]">
          ...
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('sender ID', IDIOMA), "Clickatell"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="clickatell"><!-- Clickatell -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[usuario_clickatell]">
            <?php _e('Username:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('username', IDIOMA), "Clickatell"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="clickatell"><!-- Clickatell -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[contrasena_clickatell]">
            <?php _e('Password:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('password', IDIOMA), "Clickatell"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="clockwork"><!-- Clockwork -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[identificador_clockwork]">
          ...
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('key', IDIOMA), "Clockwork"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="bulksms"><!-- BulkSMS -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[usuario_bulksms]">
          ...
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('username', IDIOMA), "BulkSMS"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="bulksms"><!-- BulkSMS -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[contrasena_bulksms]">
          ...
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('password', IDIOMA), "BulkSMS"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="open_dnd"><!-- OPEN DND -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[identificador_open_dnd]">
          ...
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('sender ID', IDIOMA), "OPEN DND"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="open_dnd"><!-- OPEN DND -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[usuario_open_dnd]">
          ...
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('username', IDIOMA), "OPEN DND"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top" class="open_dnd"><!-- OPEN DND -->
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[contrasena_open_dnd]">
          ...
          <img class="help_tip" data-tip="<?php echo sprintf(__('The %s for your account in %s', IDIOMA), __('password', IDIOMA), "OPEN DND"); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top">
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[telefono]">
            <?php _e('Your mobile number:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php _e('The mobile number registered in your SMS gateway account and where you receive the SMS messages', IDIOMA); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top">
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[notificacion]">
            <?php _e('New order notification:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php _e("Check if you want to receive a SMS message when there's a new order", IDIOMA); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
      ...
      <tr valign="top">
        <th scope="row" class="titledesc"> <label for="apg_sms_settings[internacional]">
            <?php _e('Send international <abbr title="Short Message Service" lang="en">SMS</abbr>?:', IDIOMA); ?>
          </label>
          <img class="help_tip" data-tip="<?php _e('Check if you want to send international SMS messages', IDIOMA); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png');?>" height="16" width="16" /> </th>
